...
import com.xeno.ui.WelcomeBanner
...
object BatteryWatcher {
    ...
    fun load() {
        runCatching {
            enabled.value = com.xeno.runtime.MainActivityRuntime.prefs.getBoolean(PREF_KEY, false)
        }
    }
    ...
    fun set(value: Boolean) {
        enabled.value = value
        runCatching {
            com.xeno.runtime.MainActivityRuntime.prefs.edit().putBoolean(PREF_KEY, value).apply()
        }
    }
