...
val EN: Map<String, String> = mapOf(
    ...
    "friends.explain" to "Link Discord to show what you're playing and see which friends are in XENO. Uses your existing Discord friends — XENO keeps no account and runs no server. Only while the app is open.",
    ...
    "friends.playingNow" to "In XENO now",
    "friends.nobody" to "None of your Discord friends are in XENO right now.",
    "friends.notify" to "Notify me in game",
    "friends.notify.desc" to "Show a message over the game when a friend starts playing XENO.",
    ...
    "about.rpcs3.description" to "XENO is built on the open-source RPCS3 emulator.",
    ...
    "update.checkOnLaunch.desc" to "Automatically check GitHub for a new version each time XENO starts.",
    ...
    "app.bootLogo.desc" to "Play the XENO intro video when the app starts.",
    ...
    // Google Drive Sync
    "gdrive.section.title" to "Google Drive Sync",
    "gdrive.section.description" to "Mirror your save data and play games from Google Drive. Uses the hidden appDataFolder — no folders clutter your Drive, and quota is per-app. No server needed, just your Google account.",
    "gdrive.section.hint" to "Sign in with your Google account. Your saves and games are stored in a hidden app folder, not visible in Drive UI.",
    "gdrive.signin" to "Sign in with Google",
    "gdrive.signout" to "Sign out",
    "gdrive.signedin" to "Signed in as %s",
    "gdrive.notsignedin" to "Not signed in",
    "gdrive.autopush" to "Sync saves when a game exits",
    "gdrive.autopush.description" to "Uploads every save folder after the emulator shuts down, and again on app close, while signed in to Google Drive.",
    "gdrive.push" to "Sync now",
    "gdrive.pull" to "Pull saves",
    "gdrive.working" to "Working\u2026",
    "gdrive.pushed" to "Uploaded %d save(s) to Google Drive.",
    "gdrive.pulled" to "Downloaded %d save(s) from Google Drive. On a fresh install, saves are pulled from Drive even when no local folders exist yet.",
    "gdrive.failed" to "Sync failed: %s",
    "gdrive.signin.failed" to "Google sign-in failed: %s",
    "gdrive.signin.cancelled" to "Google sign-in cancelled.",
    "gdrive.signin.working" to "Signing in\u2026",
    ...
    "github.repo.field" to "xeno-saves",
    "github.save" to "Save",
    ...
    "perf.mali.preset.label" to "Apply Mali GPU preset",
    "perf.mali.preset.description" to "Detected %s \u00b7 one-tap preset tuned for this Mali tier (SPU threads, SPU block size, shader mode, VRAM cap, upscale). Nothing else in the overlay changes \u2014 your per-game tweaks are preserved.",
    "perf.mali.preset.apply" to "Apply Mali preset",
    "perf.mali.preset.applied" to "Applied",
    ...
    "hotkeys.exitToLauncher.description" to "When a game was launched from another app (e.g. ES-DE), Close Game returns to that app instead of the XENO library.",
    ...
    "overlay.osdSize.description" to "Size of the on-screen display drawn over the game — FPS, stats and notifications. Does not affect the app's menus. 100% = RPCS3's default; XENO ships 65% so it doesn't crowd a handheld screen.",
    ...
    "setup.core.notInstalled" to "Emulator core not installed",
    "setup.core.desc" to "The ~60 MB emulator core is downloaded once from the GitHub release into the app's private storage before firmware can be installed. It is not bundled in the APK.",
    "setup.core.downloading" to "Downloading emulator core…",
    "setup.core.download" to "Download core",
    "setup.core.retry" to "Retry download",
    ...
    "setup.systemDir.intro" to "XENO stores PS3 save data, save states, configs, and shader caches in app-private storage by default. ",
    "setup.systemDir.sdCard" to "SD Card",
    "setup.toggle.off" to "Off",
    "setup.welcome.heading" to "Welcome to XENO setup!",
    ...
    // it read "Built-in (default)" on the XENO row, which stopped being true when
    // XENO Textured became the default.
