...
object ThemePreferences {
    ...
    // XENO ships PURPLE by default -- the PS3 house colour. XENO defaulted to
    // System, which resolves to the blue Night scheme and made the whole app look
    // like XENO. Users can still pick anything in Settings; this is only the
 ...
 *  [com.xeno.BootSplashActivity] straight from the "XENO" prefs (key
 ...
 *  by [com.xeno.ui.home.XmbGlView]. The theme accent ([ThemePreferences.customColor]) only
