...
import com.xeno.ui.achievements.parseAchievementItems
...
enum class EmulationMenuTab(val titleKey: String) {
    ...
    // XENO's answer to the (hidden) Achievements tab: the RUNNING game's real PS3
    ...
    companion object {
        /**
         * XENO: tabs actually shown. Achievements is hidden because
...
class EmulationMenuViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun load(initialTab: EmulationMenuTab?) {
        ...
        val gameCRC = runCatching { NativeApp.getGameCRC().orEmpty().trim().uppercase() }
            .getOrDefault("")
            .takeIf { it.matches(com.xeno.DiscIdentity.CRC_PATTERN) && it != "00000000" }
            .orEmpty()
        ...
        state.value = state.value.copy(
            ...
            settings = settings,
            touchControlsVisible = com.xeno.ui.touch.TouchControls.visible.value,
    ...
    fun selectTab(tab: EmulationMenuTab) {
        ...
        if (tab != state.value.tab) com.xeno.MenuSfx.play(com.xeno.MenuSfx.Event.NAV)
    ...
    fun moveSelection(delta: Int) {
        ...
        if (next != before) com.xeno.MenuSfx.play(com.xeno.MenuSfx.Event.NAV)
     ...
     */
    fun openFullSettings() = com.xeno.ui.WindowImpl.openInGameScreen(com.xeno.ui.InGameScreen.Settings)
     ...
     */
    fun openCoreSettings() = com.xeno.ui.WindowImpl.openInGameScreen(com.xeno.ui.InGameScreen.CoreSettings)
    ...
    fun openControlsManager() = com.xeno.ui.WindowImpl.openInGameScreen(com.xeno.ui.InGameScreen.Controls)

    fun openTextures() = com.xeno.ui.WindowImpl.openInGameScreen(com.xeno.ui.InGameScreen.Textures)

    fun openSkins() = com.xeno.ui.WindowImpl.openInGameScreen(com.xeno.ui.InGameScreen.Skins)
    ...
    // the hardware-info line, and the "XENO <version>" banner. Granular control of
    ...
    fun toggleTouchControls() {
        ...
        com.xeno.ui.touch.TouchControls.visible.value = enabled
    ...
    fun openAchievements() = com.xeno.ui.WindowImpl.openInGameScreen(com.xeno.ui.InGameScreen.Achievements)

    /** Open the full trophy list over the paused game, scoped to the running title. */
    fun openTrophies() = com.xeno.ui.WindowImpl.openInGameScreen(com.xeno.ui.InGameScreen.Trophies)
...
object EmulationMenuInputController {
    ...
    private val nav get() = com.xeno.ui.settings.SettingsControllerNav
    ...
    fun open(tab: EmulationMenuTab = EmulationMenuTab.Session) {
        pendingTab = tab
        if (!com.xeno.ui.WindowImpl.overlayVisible.value) InGameOverlay.open()
        owner?.selectTab(tab)
        inContent.value = false
    }
