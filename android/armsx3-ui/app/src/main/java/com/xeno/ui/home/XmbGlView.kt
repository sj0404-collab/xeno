...
class XmbGlView(context: Context) : TextureView(context), TextureView.SurfaceTextureListener {
    ...
    private class RenderThread(
        ...
        private fun drawFrame(timeSec: Float) {
            ...
            val top: FloatArray
            val bot: FloatArray
            if (com.xeno.ui.theme.LibraryBackgroundColorPreferences.rgbCycleGl) {
                bot = hsvToRgb(((timeSec / RGB_CYCLE_SEC) % 1f) * 360f, 0.92f, 0.98f)
                top = floatArrayOf(bot[0] * 0.20f, bot[1] * 0.20f, bot[2] * 0.20f)
            } else {
                top = com.xeno.ui.theme.LibraryBackgroundColorPreferences.glTop ?: BG_TOP
                bot = com.xeno.ui.theme.LibraryBackgroundColorPreferences.glBottom ?: BG_BOT
            }
    ...
    companion object {
        ...
        // XENO purple, to match the default Purple theme accent (0xFFC7A6FF).
        // XENO's blue gradient is what made the library still look like XENO
