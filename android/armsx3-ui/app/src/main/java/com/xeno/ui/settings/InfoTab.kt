...
fun InfoTab(game: GameInfo?) {
    ...
    val crc by androidx.compose.runtime.produceState<String?>(initialValue = null, game.uri) {
        value = com.xeno.DiscIdentity.resolve(game.uri, serial)
    }
    ...
    GlassPanel(Modifier.fillMaxWidth()) {
        Column {
            ...
            InfoRow(
                ...
                com.xeno.Ps3Sfo.installedUpdateVersion(serial)
                    ?.let { "$it (update)" }
                    ?: str("info.noUpdate"),
                clipboard,
            )
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                val openRename = {
                    ...
                    LibraryKeyboard.open(
                        ...
                        onChange = {},
                        placeholder = com.xeno.i18n.I18n.get("info.customName.placeholder"),
                    )
                }
                OutlinedButton(
                    onClick = openRename,
