...
import com.xeno.ShaderParams
import com.xeno.config.Settings.Companion.emitSink
import com.xeno.config.Settings.Companion.merge
...
data class Settings(
    ...
    /** EmuCore/Speedhacks/vuNeonFusions — XENO-only. Gates the arm64
     ...
     *  turns it into the XENO_ANGLE_EGL_LIBRARY env var that GLContextEGL reads.
     ...
     *
     *  The name is XENO's. RPCS3 has no emulated USB HID keyboard device; it has a
    ...
    private fun applyToInner() {
        ...
        dev9EthHosts.forEachIndexed { i, h ->
            ...
            put("DEV9/Eth/Hosts/Host$i", "Desc", "string", "XENO")
    ...
    private fun writeGsToNative() {
        ...
        // Parity write (native reads the XENO_ANGLE_EGL_LIBRARY env var set by
    ...
    companion object {
         ...
         *  [mtvu] is passed in (from [com.xeno.DeviceTier.mtvuDefault]) rather
