...
import com.xeno.R
import com.xeno.ShaderParam
import com.xeno.ShaderParams
import com.xeno.ShaderRepo
import com.xeno.i18n.str
import com.xeno.ui.settings.HelpText
import com.xeno.ui.settings.IntSliderRow
 ...
 * jobs and only one of them can be left to [com.xeno.config.Settings.applyTo]:
...
private fun ShaderPresetPicker(preset: String, onPresetChange: (String) -> Unit) {
    ...
    fun navigateTo(folderKey: String) {
        // A controller-confirmed folder is about to dispose its own selected row. XENO's
