...
object SecondScreen {
    ...
    private fun applyOsdRouting() {
        ...
        runCatching {
            if (suppress) {
                ...
                com.xeno.ui.InGameOverlay.reapplyOsdMode()
            }
        }
    }
    ...
    /** Whether XENO is in the foreground. A Presentation belongs to the app's window token but
    ...
    private class Panel(context: Context, display: Display) : Presentation(context, display) {
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            var macroCount = 0
            listOf(
                com.xeno.ui.touch.TouchButtonId.MACRO1,
                com.xeno.ui.touch.TouchButtonId.MACRO2,
                com.xeno.ui.touch.TouchButtonId.MACRO3,
                com.xeno.ui.touch.TouchButtonId.MACRO4,
            ).forEach { id ->
                if (runCatching { com.xeno.ui.touch.TouchControls.macroCodes(id).isEmpty() }
                        .getOrDefault(true)
                ) return@forEach
                macroCount++
        ...
        private fun macroAction(id: com.xeno.ui.touch.TouchButtonId): View =
                ...
                setOnTouchListener { v, ev ->
                    when (ev.actionMasked) {
                        android.view.MotionEvent.ACTION_DOWN -> {
                            runCatching {
                                com.xeno.ui.touch.TouchControls.fireMacro(id, "secondScreen", true) { code, pressed ->
                        ...
                        android.view.MotionEvent.ACTION_CANCEL -> {
                            runCatching {
                                com.xeno.ui.touch.TouchControls.fireMacro(id, "secondScreen", false) { code, pressed ->
                                    NativeApp.setPadButton(code, 0, pressed)
                                }
                            }
                            v.isPressed = false
