...
object LibraryKeyboard {
    ...
    fun setUseSystemIme(on: Boolean) {
        ...
        com.xeno.runtime.MainActivityRuntime.prefs.edit().putBoolean(SystemImeKey, on).apply()
    }
    ...
    fun refreshUseSystemIme(): Boolean {
        useSystemIme.value = runCatching {
            com.xeno.runtime.MainActivityRuntime.prefs.getBoolean(SystemImeKey, false)
        }.getOrDefault(false)
    ...
    fun pressKey(key: String) {
        ...
        com.xeno.MenuSfx.play(if (key == DONE) com.xeno.MenuSfx.Event.SELECT else com.xeno.MenuSfx.Event.NAV)
