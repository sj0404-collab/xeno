...
fun DriverManagerSection() {
    ...
    Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        ...
        val gpuModel = remember { com.xeno.GpuInfo.rendererName() }
        val gpuRec = remember(gpuModel) { com.xeno.GpuInfo.recommendation(gpuModel) }
        Surface(
        ...
        if (!com.xeno.NativeApp.supportsCustomVulkanDriver()) {
            Surface(
                shape = RoundedCornerShape(16.dp),
