...
object ConfigStore {
    ...
    private const val BACKUP_FILENAME = "xeno-settings.json"

    // What the mirror was called when this app was still branded XENO (issue #82). Anyone
    ...
    private const val LEGACY_BACKUP_FILENAME = "xeno-settings.json"
    ...
    /** The mirror to READ: the current name, or the XENO-era one if that is all there is. */
    ...
    fun reconcileReusedFolder() {
        ...
        // Reads the XENO-era name too: for anyone upgrading it is the only copy there is.
        ...
        // that emulator under its own package, so nothing under com.xeno can ever have one.
    }
