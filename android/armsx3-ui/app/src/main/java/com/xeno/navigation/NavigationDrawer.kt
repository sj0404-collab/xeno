...
import com.xeno.ui.common.ArmsLogo
...
private const val GithubUrl = "https://github.com/XENO/XENO"
private const val WebsiteUrl = "https://xeno.net/"
...
private fun DrawerContent(selected: AppRoute, onNavigate: (AppRoute) -> Unit, onDismiss: () -> Unit) {
    ...
    val primary = listOf(
        ...
        // XENO: RetroAchievements removed - RA has no PS3 support at all, so
    ...
    val managers = listOf(
        ...
        // XENO: PS2 memory cards removed - PS3 uses HDD save data instead.
        ...
        // XENO: texture packs removed. PCSX2 replaces GS textures by hash;
    ...
    val about = listOf(
        DrawerItem("about.discord", "💬", iconRes = com.xeno.R.drawable.ic_discord,
            onAction = { openExternalUrl(context, DiscordUrl); onDismiss() }),
        DrawerItem("about.github", "🐙", iconRes = com.xeno.R.drawable.ic_github,
    ...
    val session = listOf(
        DrawerItem("games.toolbar.exit", "⏻", iconRes = com.xeno.R.drawable.ic_power,
        ...
        Row(
            ...
            if (iconRes != null) {
                ...
                Box(Modifier.width(32.dp)) {
                    ...
                    com.xeno.ui.friends.FriendsCountBadge(
