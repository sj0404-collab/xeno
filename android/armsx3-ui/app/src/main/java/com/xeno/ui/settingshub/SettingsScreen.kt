package com.xeno.ui.settingshub
...
import com.xeno.navigation.SettingsCategory
...
import com.xeno.ui.settings.AppTab
import com.xeno.ui.settings.AudioTab
import com.xeno.ui.settings.FixesTab
import com.xeno.ui.settings.HotkeysTab
import com.xeno.ui.settings.NetworkTab
import com.xeno.ui.settings.OverlayTab
import com.xeno.ui.settings.PadTab
import com.xeno.ui.settings.PerformanceTab
import com.xeno.ui.settings.RendererTab
import com.xeno.ui.settings.SegmentedRow
import com.xeno.ui.settings.SkinsTab
import com.xeno.ui.settings.LocalSettingsScrollState
...
fun SettingsScreen(
    ...
    val scopeContext = game ?: com.xeno.runtime.MainActivityRuntime.currentGame.value
    ...
    val playScoped: (com.xeno.GameInfo) -> Unit = { g ->
        com.xeno.navigation.UiNavigator.navigate(com.xeno.navigation.AppRoute.Home)
        ...
        com.xeno.runtime.MainActivityRuntime.launchGame(launchPath, g)
    }
    ...
    LaunchedEffect(com.xeno.ui.settings.SettingsControllerNav.selectedIndex.intValue) {
        if (!chipSnapArmed.value) {
            chipSnapArmed.value = true
            return@LaunchedEffect
        }
        if (com.xeno.ui.settings.SettingsControllerNav.currentSelectedId()?.startsWith("settings.chip.") == true) {
    ...
    LaunchedEffect(pendingJump) {
        ...
        var tries = 0
        while (tries < 40 && !com.xeno.ui.settings.SettingsControllerNav.selectByLabel(anchor)) {
        ...
        com.xeno.ui.common.ConfirmOverlay(
            ...
            onConfirm = {
                if (displayedCategory == SettingsCategory.Controls) {
                    ...
                    com.xeno.input.ControllerMappings.resetAllControls(scopeGame?.settingsKey)
                } else {
...
private fun CategoryContent(category: SettingsCategory, viewModel: SettingsViewModel) {
    when (category) {
        ...
        SettingsCategory.Info -> com.xeno.ui.settings.InfoTab(viewModel.uiState.value.game)
        ...
        SettingsCategory.Patches -> com.xeno.ui.patches.Ps3PatchesTab(
