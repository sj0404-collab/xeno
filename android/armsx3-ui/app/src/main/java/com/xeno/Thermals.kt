 ...
 *
 * Ported from XENO's Thermals.kt. The core cannot read these and should not learn how -- see
...
object Thermals {
     ...
     * single `<= none` comparison rather than carrying a second flag per value. XENO spells
     ...
     * rather than something wrong -- so there is no device this is worse for. (XENO shipped it
