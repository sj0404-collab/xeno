...
object PadRouter {
    ...
    fun loadPins() {
        ...
        rumbleModes.clear()
        runCatching {
            val raw = com.xeno.runtime.MainActivityRuntime.prefs.getString(KEY_PINNED, null)
            if (raw != null) {
        ...
        runCatching {
            val raw = com.xeno.runtime.MainActivityRuntime.prefs.getString(KEY_RUMBLE, null)
            if (raw != null) {
                val obj = org.json.JSONObject(raw)
                for (key in obj.keys()) {
    ...
    fun setRumbleMode(descriptor: String, mode: RumbleMode) {
        ...
        com.xeno.runtime.MainActivityRuntime.prefs.edit().putString(KEY_RUMBLE, obj.toString()).apply()
    }
