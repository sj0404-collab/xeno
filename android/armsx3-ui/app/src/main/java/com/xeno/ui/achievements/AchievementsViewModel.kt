...
class AchievementsViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun refresh() {
        ...
        if (snapshot != null && snapshot.items.isNotEmpty()) {
            runCatching {
                com.xeno.PlayTime.recordAchievements(
                    com.xeno.runtime.MainActivityRuntime.currentGame.value?.serial
    ...
    fun confirmToggleHardcore() {
        ...
        if (target && com.xeno.runtime.MainActivityRuntime.eState.value != com.xeno.EmuState.STOPPED) {
            com.xeno.runtime.MainActivityRuntime.restart()
            com.xeno.ui.WindowImpl.dismissInGameScreen()
        }
        refresh()
    }
    ...
    private fun parse(json: String): AchievementsUiState {
        ...
        return AchievementsUiState(
            ...
            userName = root.optString("userName").also {
                ...
                com.xeno.RaLibrary.userName = it
            },
