...
object GithubSaveSync {
    ...
    fun load() {
        val prefs = com.xeno.runtime.MainActivityRuntime.prefs
    ...
    fun setAutoPush(enabled: Boolean) {
        autoPush = enabled
        com.xeno.runtime.MainActivityRuntime.prefs.edit().putBoolean(PREF_AUTO, enabled).apply()
    }
    ...
    suspend fun pushAll(): Int = withContext(Dispatchers.IO) {
        ...
        var pushed = 0
        try {
            com.xeno.CloudSync.syncMutex.withLock {
                ...
                root.listFiles().orEmpty()
                    ...
                    .forEach { dir ->
                        ...
                        try {
                            ...
                            val json = JSONObject()
                                .put("message", "XENO save sync: ${dir.name}")
